...
/// <summary>
/// Extension methods for registering NginxApiClient with Newtonsoft.Json serialization
/// in an <see cref="IServiceCollection"/>.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds NginxApiClient services to the DI container using Newtonsoft.Json serialization.
    /// </summary>
